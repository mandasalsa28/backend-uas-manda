  ...
  <div class="login-box">
    ...
    <div class="card card-outline card-primary">
      ...
      <div class="card-body">
        ...
        <form action="<?= base_url('login_07/proses_login') ?>" method="post">
        ...
        <p class="mb-0">
          <a name="register" href=" <?php echo base_url('register_07') ?> " class="text-center">Belum punya akun? Register disini</a>
        </p>
      </div>
      <!-- /.card-body -->
    </div>
